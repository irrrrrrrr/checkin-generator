...
class MainWindow(QtWidgets.QMainWindow):
    def __init__(self):
        ...
        self.load_config()
        print("Config and window settings loaded")
        ...
        try:
            with open(CONFIG_FILE, 'r') as file:
                ...
                if config:
                    ...
                    # 加载窗口位置和大小
                    rect = config.get('geometry', {})
                    self.setGeometry(QtCore.QRect(rect.get('x', 100), rect.get('y', 100),
                                                  rect.get('width', 800), rect.get('height', 600)))
        except FileNotFoundError:
            print("Config file not found")
            self.setGeometry(100, 100, 800, 600)  # 默认窗口大小和位置
    ...
    def save_config(self):
        ...
        print("Config and window settings saved")
